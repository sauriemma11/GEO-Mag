...
def fix_nan_for_goes(data, nanvalue=-9998.0):
    ...
    :param data: dataset
    :param nanvalue:The value used to identify NaN values (default: -9998.0, which replaces -9999)
...
def get_date_str_from_goesTime(goes_time):
    """
    Get a date string in the format 'YYYY-MM-DD' from GOES timestamps. Used in plotting functions
